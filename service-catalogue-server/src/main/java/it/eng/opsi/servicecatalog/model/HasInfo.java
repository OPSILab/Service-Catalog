...
@JsonPropertyOrder({ "identifier", "title", "status", "keyword", "sector", "thematicArea", "type", "language",
		"description", "processingTime", "isGroupedBy", "hasCompetentAuthority", "requires", "spatial", "hasInput",
		"produces", "hasContactPoint", "hasChannel" })
public class HasInfo {
	 ...
	 * @param requires
	 */
	public HasInfo(String identifier, String title, String status, List<String> keyword, List<String> sector,
			List<String> thematicArea, List<String> type, List<String> language, Description description,
			String processingTime, List<String> isGroupedBy, HasCompetentAuthority hasCompetentAuthority,
			List<String> requires, String spatial, List<HasInput> hasInput, List<Produce> produces,
			HasContactPoint hasContactPoint, List<HasChannel> hasChannel) {
		super();
	...
	public String toString() {
		...
		sb.append(HasInfo.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
				.append('[');
	...
	public boolean equals(Object other) {
		...
		return (((((((((((((((((((this.identifier == rhs.identifier)
				...
				&& ((this.hasContactPoint == rhs.hasContactPoint)
						|| ((this.hasContactPoint != null) && this.hasContactPoint.equals(rhs.hasContactPoint))))
				&& ((this.hasChannel == rhs.hasChannel)
						|| ((this.hasChannel != null) && this.hasChannel.equals(rhs.hasChannel))))
				&& ((this.hasCompetentAuthority == rhs.hasCompetentAuthority) || ((this.hasCompetentAuthority != null)
						&& this.hasCompetentAuthority.equals(rhs.hasCompetentAuthority))))
				...
				&& ((this.isGroupedBy == rhs.isGroupedBy)
						|| ((this.isGroupedBy != null) && this.isGroupedBy.equals(rhs.isGroupedBy))))
				&& ((this.title == rhs.title) || ((this.title != null) && this.title.equals(rhs.title))))
				&& ((this.type == rhs.type) || ((this.type != null) && this.type.equals(rhs.type))))
				&& ((this.processingTime == rhs.processingTime)
						|| ((this.processingTime != null) && this.processingTime.equals(rhs.processingTime))))
				&& ((this.produces == rhs.produces) || ((this.produces != null) && this.produces.equals(rhs.produces))))
				&& ((this.keyword == rhs.keyword) || ((this.keyword != null) && this.keyword.equals(rhs.keyword))))
				&& ((this.spatial == rhs.spatial) || ((this.spatial != null) && this.spatial.equals(rhs.spatial))))
				&& ((this.hasInput == rhs.hasInput) || ((this.hasInput != null) && this.hasInput.equals(rhs.hasInput))))
				&& ((this.sector == rhs.sector) || ((this.sector != null) && this.sector.equals(rhs.sector))))
				&& ((this.thematicArea == rhs.thematicArea)
						|| ((this.thematicArea != null) && this.thematicArea.equals(rhs.thematicArea))))
				&& ((this.status == rhs.status) || ((this.status != null) && this.status.equals(rhs.status))))
				&& ((this.requires == rhs.requires)
						|| ((this.requires != null) && this.requires.equals(rhs.requires))));
	}
