...
public class Description__5 {
     ...
     * @param title
     */
    public Description__5(String locale, String title, String description, String descriptionUrl, String iconUrl) {
        super();
        this.locale = locale;
        this.title = title;
    ...
    public String toString() {
        ...
        sb.append(Description__5 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("locale");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Description__5) == false) {
            return false;
        }
        Description__5 rhs = ((Description__5) other);
